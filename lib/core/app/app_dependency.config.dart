...
import '../../features/screens/login/cubit/login_cubit.dart' as _i11;
import '../../features/screens/login/repository/login_repo.dart' as _i10;
import '../../features/screens/login/repository/login_repo_imp.dart' as _i9;
...
import 'app_dependency.dart' as _i12;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i9.LoginRepositoryImp>(
      () => _i10.LoginRepository(apiClient: get<_i8.ApiClient>()));
  gh.factory<_i11.LoginCubit>(
      () => _i11.LoginCubit(get<_i9.LoginRepositoryImp>()));
  return get;
}
